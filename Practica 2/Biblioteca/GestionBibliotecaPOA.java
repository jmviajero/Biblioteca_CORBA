 ...
 implements Biblioteca.GestionBibliotecaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("prestarLibro", new java.lang.Integer (3));
    _methods.put ("devolverLibro", new java.lang.Integer (4));
  }
  ...
  // Busca un libro por título y devuelve los detalles del libro
       ...
       case 1:  // Biblioteca/GestionBiblioteca/agregarLibro
       {
         ...
         boolean disponible = in.read_boolean ();
         this.agregarLibro (ISBN, titulo, autor, disponible);
         out = $rh.createReply();
         break;
       }

       case 2:  // Biblioteca/GestionBiblioteca/eliminarLibro
       {
         String ISBN = in.read_string ();
  ...
  // Presta un libro, cambiando su estado a no disponible
       case 3:  // Biblioteca/GestionBiblioteca/prestarLibro
       {
         String ISBN = in.read_string ();
  ...
  // Devuelve un libro, cambiando su estado a disponible
       case 4:  // Biblioteca/GestionBiblioteca/devolverLibro
       {
         String ISBN = in.read_string ();
         boolean $result = false;
