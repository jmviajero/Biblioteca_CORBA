...
class GestionBibliotecaImpl extends GestionBibliotecaPOA {
    ...
    public GestionBibliotecaImpl(ORB orb) {
        ...
        libros.put("1", new Libro("Percy Jackson", "Rick Riordan", "1234", false));
    }
    ...
    @Override
    public Libro buscarLibro(String titular) {
        for (Libro libro : libros.values()) {
            if (libro.titulo.equals(titular)) {
                return libro;
            }
        }
    ...
    @Override
    public void agregarLibro(String ISBN, String titulo, String autor, boolean disponible) {
        libros.put(ISBN, new Libro(titulo, autor, ISBN, disponible));
    }
